...
public class GetProbabilitiesResponse {
    ...
    @XmlElementRef(name = "GetProbabilitiesResult", namespace = "http://schemas.microsoft.com/research/2009/10/webngram/frontend", type = JAXBElement.class, required = false)
